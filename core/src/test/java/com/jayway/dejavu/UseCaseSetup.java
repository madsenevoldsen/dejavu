...
public class UseCaseSetup implements TraceRepository {
    ...
    public UseCaseSetup() {
        ...
        //runner.setMarshaller( MarshallerImpl.class );
        // change to make is scan a package for providers
        //runner.scanForProviders( "com.jayway.dejavu" );
        runner.addProvider( "RandomUUID", RandomUUID.class);
        runner.addProvider( "Timestamp", Timestamp.class);
        runner.addProvider( "SickProvider", SickProvider.class);

        runner.addCircuitBreaker("Sick", CircuitBreakerRepo.class);
