...
public class TraceBuilderTest {
    ...
    public void builder() throws Throwable {
        TraceBuilder builder = DejaVuEngine.createTraceBuilder().startMethod(ExampleTrace.class);
    ...
    public void simple_types_test() throws Throwable {
        TraceBuilder builder = DejaVuEngine.createTraceBuilder().startMethod(AllSimpleTypes.class);
